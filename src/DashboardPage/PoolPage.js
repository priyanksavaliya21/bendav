                            ...
                            <div className='trade_now_row'>
                                <div className='Market_Cap_row'>
                                    <div className='Market_Cap_text'>
                                        ...
                                        <h5 className='mer_text_h5'>30.94M <span>MER</span></h5>
                                    </div>
                                    <span className='Market_Cap_center_span'></span>
                                    <div className='Market_Cap_text'>
                                        <p className='Market_text_p'>Market Cap</p>
                                        <h5 className='mer_text_h5'>$ 1.03M</h5>
                                    </div>
                                </div>
                                ...
                                <div className='trade_btn_row'>
                                    ...
                                    <WebBotton WebBotton="Trade Now" link="#0" />
                                </div>
                            </div>
                                ...
                                <div className='mer_dai_drop' ref={contentEl} style={clicked ? { height: contentEl.current.scrollHeight } : { height: "0px" }}>
                                    <div className='mer_dai_drop_row'>
                                        <div className='mer_dai_drop_text'>
                                            <img src={mer_dai_drop_item_logo_1} alt="mer_dai_drop_item_logo" />
                                            <div className='mer_text'>
                                                <h5 className='mer_text_h5'>$ 6.37M</h5>
                                                <p className='Market_text_p'>Liquidity: $366,685.19</p>
                                                <p className='Market_text_p'>APY: 122.85%</p>
                                            </div>
                                            <WebOffBotton WebOffBotton="Farm" link="#0" img={View_on_Explorer_icon} />
                                        </div>
                                        <div className='mer_dai_drop_text'>
                                            <img src={mer_dai_drop_item_logo_2} alt="mer_dai_drop_item_logo" />
                                            <div className='mer_text'>
                                                <h5 className='mer_text_h5'>$ 6.37M</h5>
                                                <p className='Market_text_p'>Liquidity: $366,685.19</p>
                                                <p className='Market_text_p'>APY: 122.85%</p>
