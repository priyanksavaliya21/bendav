...
import ConnectPop_icon_1 from '../assets/images/Dashboard/ConnectPop_icon_1.svg';
import ConnectPop_icon_2 from '../assets/images/Dashboard/ConnectPop_icon_2.svg';
import ConnectPop_icon_3 from '../assets/images/Dashboard/ConnectPop_icon_3.svg';
import ConnectPop_logo from '../assets/images/Dashboard/ConnectPop_logo.svg';
import { SelectOption } from './Common/SelectOption';


const ConnectPop = ({ open, handleClose }) => {
    ...
    return (
        <>
                            ...
                            <div  className='ConnectPop_main'>
                                <div className='ConnectPop_items_block'>
                                    ...
                                    <ul className='ConnectPop_items'>
                                        ...
                                        <li>
                                            <a href="#0" onClick={()=>handleOpen1('Wallet Connect' , ConnectPop_icon_2 )}>
                                                <span>Wallet Connect</span>
                                                <img src={ConnectPop_icon_2} alt="ConnectPop_icon" />
                                            </a>
                                        </li>
                                        <li>
            ...
            <SelectOption open1={open1} handleClose1={handleClose1} MetaMask={name} ConnectPop_icon={img}/>
        </>
    );
}
