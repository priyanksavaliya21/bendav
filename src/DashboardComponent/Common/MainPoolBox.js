                    ...
                    <div className='Withdraw_main_row'>
                        <div className='Withdraw_main_row_row'>
                            <div className='coverage_ratio_block'>
                                ...
                                <p className='ratio_common_p'>Coverage Ratio: <span>{Item.CoverageRatio}</span> <img src={akar_icons_question} alt="akar_icons_question" /></p>
                            </div>
                            <div className='deposits_block'>
                                <p className='Market_text_p'>Pool Deposits</p>
                                <h5 className='mer_text_h5'>{Item.PoolDepositsNum}</h5>
                                <p className='Market_text_p'>{Item.PoolDepositsNum2}</p>
                            </div>
                            <span className='Market_Cap_center_span'></span>
                            <div className='deposits_block deposits_block_line'>
                                <p className='Market_text_p'>Volume 24H</p>
                                <h5 className='mer_text_h5'>{Item.Volume24HNum}</h5>
                        ...
                        <div className='trade_btn_row'>
                            <WebOffBotton WebOffBotton="Deposit" link="#0" click={handleOpen} />
                            <WebBotton WebBotton="Withdraw" link="#0" click={handleOpen} />
                        </div>
                    </div>
                                ...
                                item.map((item, index) => {
                                    return (
                                        <div className='stock_index' key={index}>
                                            <StockFilter Item={item} handleOpen={handleOpen} />
                                        </div>
                                    )
                                })
                            }
